...
namespace BUNIFU
{
    public partial class frmUsuariosAdministrador : Form
    {
        Usuario userSucursal;
        public frmUsuariosAdministrador(Usuario p_usser)
        {
            InitializeComponent();
            userSucursal = p_usser;
        }

        private void frmUsuariosAdministrador_Load(object sender, EventArgs e)
        {
        ...
        private void dataGridUsser_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            //Si se hace click =>
        ...
        private void guardar_Click_1(object sender, EventArgs e)
        {
            ...
            Usuario usuario1 = new Usuario()
            {
                ...
                id_sucursal = userSucursal.id_sucursal,
            ...
            else /*si ya esta registrado se procedera a editarlo*/
            {
                ...
                if (resultado == 1)
                {
                    ...
                    row.Cells["id_Sucursal"].Value = userSucursal.id_sucursal;
